...
<template>
    <div class="el-tree-select" :class="selectClass">
        ...
        <el-popover ref="popover" :placement="placement" :popper-class="popperClass" :width="width" v-model="visible" trigger="click">
            <!-- 是否显示搜索框 -->
            <el-input v-if="treeParams.filterable" v-model="keywords" clearable size="mini" class="input-with-select mb10"
                      @clear="_searchFun" @keyup.enter.native="_searchFun"
            >
                <el-button slot="append" icon="el-icon-search" @click.prevent.native="_searchFun"></el-button>
            </el-input>
